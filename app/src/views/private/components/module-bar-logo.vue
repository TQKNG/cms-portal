...
const customLogoPath = computed<string | null>(() => {
  ...
  let project_logo = settingsStore.settings.project_logo;

  if (userStore.currentUser?.email.includes('trinity')) {
    project_logo = `https://cmsportal.blob.core.windows.net/cmsportal/9239877B-0312-46C4-A4AA-B58271EE2702.png`;
	return project_logo

  }

  if (userStore.currentUser?.email.includes('salvation')) {
    project_logo = 'https://cmsportal.blob.core.windows.net/cmsportal/D9948657-0162-433A-A269-BDBA9EF7AD8F.png';
	return project_logo
  }

   return getAssetUrl(project_logo)
